  ...
  server.registerTool(
    "update_course_topics",
    {
      description: "Оновлює теми для активної дисципліни в контексті. Зазвичай кожна тема займає 2 або 4 години лекцій. Та має 0 або 2 чи 4 години практичних. " +
        ...
        "години лекцій та практичних чи лабораторних на їх на перші теми з кожної атестації (скільки вистачить), а всі інші вистав в 0. А самостійну роботу роздподіли рівномірно по темам." +
        ...
        "Якщо тема має години практичних чи лабораторних, додай відповідні заняття в список practices як об'єкти з полями name і description. В назві практичних не додавай додаткових пояснень чи тексту практична роботи чи номеру" +
